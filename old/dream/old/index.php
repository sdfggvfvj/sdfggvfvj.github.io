...
<div class='intro'><p> ↑scroll right to see more pics↑</p></div>
        ...
        <div id="sliders">
            ...
            <input class="bouton" type="submit" value="Submit" name="submit">
        </form>
      <p><button class="bouton" id="suppr">DELETE IMAGE</button></p>
        <p><button class="bouton" id="duplicate">Duplicate</button></p>
            <div class= 'scale'>
            <p>SCALE X+Y
        ...
        <textarea id="txtArea" placeholder="describe your dream here"></textarea>
