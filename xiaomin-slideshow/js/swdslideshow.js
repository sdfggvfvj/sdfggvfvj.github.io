...
document.addEventListener("DOMContentLoaded", function (event) {
  ...
  */
  ...
  let leftArrowElement = '<span class="arrow-left arrow">\x3c</span>';
  let rightArrowElement = '<span class="arrow-right arrow">\x3e</span>';
  ...
  const slides = document.querySelectorAll(".imgs > div");
  const arrowLeft = document.querySelector(".imgs .arrow-left");
  const arrowRight = document.querySelector(".imgs .arrow-right");
